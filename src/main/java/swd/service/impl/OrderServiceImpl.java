...
import swd.Converter.OrderMaster2OrderDTOConverter;
...
import swd.repository.OrderDetailRepository;
import swd.repository.OrderMasterRepository;
import swd.service.OrderService;
import swd.service.ProductService;
import swd.utils.KeyUtil;
...
public class OrderServiceImpl implements OrderService
{
    ...
    public OrderDTO create(OrderDTO orderDTO)
    {
        ...
        //扣库存
        List<CartDTO> cartDTOList = orderDTO.getOrderDetailList().stream().map(i ->
                new CartDTO(i.getProductId(), i.getProductQuantity()))
    ...
    public Page<OrderDTO> findList(String buyerOpenid, Pageable pageable)
    {
        ...
        Page<OrderDTO> pages = new PageImpl<OrderDTO>(orderDTOS, pageable, orderMasters.getTotalElements());
        return pages;
    }
